...
def apply_vad_pipeline(
    ...
    pipeline = Pipeline.from_pretrained("pyannote/voice-activity-detection", use_auth_token=os.environ["HF_TOKEN"])
...
if __name__ == "__main__":
    audio_file = "data/ch1-netfrix.mp3"
    vad_result = apply_vad_pipeline(audio_file, duration_seconds=60)
