...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate ground-truth diarizatApply VAD to input audio files, and mix them into a single RTTM file."
    )
    parser.add_argument(
        "--input-file",
        "-i",
        help="Path to an input audio file(s). For more than one file, use space-separated paths.",
        type=str,
        nargs="+",
        required=True,
    )
